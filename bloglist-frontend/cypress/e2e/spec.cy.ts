  ...
  describe('When logged in', function() {
    ...
    describe('Multiple blogs exist', function() {
      ...
      it('The blog with the most likes is first', function() {
        ...
        cy.get('.blog').eq(0).should('contain', 'Blog with the most likes Blog with the most likes')
        cy.get('.blog').eq(1).should('contain', 'Testing title field Testing author field')
      })
    })
  })
})